<html>
	<head>el="icon" type="image/gif" href="resources/img/icon/long-den.jpg" />
        <title>Liên hệ</title>
	</head>	
    <body>
        <?php 
        ...
        <div class="lien-he">
        	<div class="contact-info">
        		...
        		<p class="title-company">Công ty TNHH <strong>MUCNOW</strong></p>
        		<br/>
        		<p style="font-size: 40px">Địa chỉ: 27/4D Đông Lân, Bà Điểm, Hóc Môn, HCM</p>
        		<br/>
        		<p style="font-size: 40px">Điện thoại: 036.381.0003 hoặc 093.202.2210</p>
        		<br/>
        		<p style="font-size: 40px">Email: mucnow99@gmail.com</p>
        		<br/>
        		<p style="font-size: 40px">Skype: thevinh_205</p>
        		<br/>
        		<p style="font-size: 40px">Fanpage: <a class="name-fanpage" target="_blank" href="https://www.facebook.com/mucnow">MUCNOW</a></p>
        	</div>
        	<div class="send-message">
        		...
        		<br/>
        		<input type="submit" class="submit-send-message" title="GỬI" value="GỬI" onclick="sendMessage()"/>
        	</div>
