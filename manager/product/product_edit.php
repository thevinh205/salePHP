<html>
	<?php 
		...
		$sql1="SELECT id, name, price_sell, price_buy, price_prom, prom, avatar, product_type, description, avatar, show_web, guarantee FROM product WHERE id='".$productId."'";
    ...
    <form class="form-horizontal">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label class="form-control-label col-sm-4">Khuyến mãi</label>
                <div class="col-sm-8"> 
                    <input type="checkbox" name="promEdit" value="<?php echo $row1['prom'];?>" <?php if($row1['prom'])echo 'checked'; ?>/>
                </div>
            </div>
            <div class="form-group">
                <label class="form-control-label col-sm-4">Giá khuyến mãi</label>
                <div class="col-sm-8"> 
                    <input type="text" class="form-control numbers" name="pricePromEdit" value="<?php echo $row1['price_prom']; ?>"/>
                </div>
            </div>
            <div class="form-group">
